...
let groceryItems = fileUtility.readFromFileIfFileExists('./grocerylist.json');//Empty array if file doesn't exist, or populated array if file exists
...
while (true) {
    ...
    if (input === '1'){
        ...
        fileUtility.convertObjectToJsonAndSaveJsonToFile('./grocerylist.json', groceryItems);
    }
}